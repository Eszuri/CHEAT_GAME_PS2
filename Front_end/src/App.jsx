...
import DynastyWarrior6 from "./list-cheat/D/DynastyWarrior6";
import Tutorial from "./components/Tutorial";
import JokerCommand, { ListJokerCommand } from "./TutorialPages/JokerCommand";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/tutorial/create-pnach-code" element={<MakePnach />} />
        <Route path="/tutorial/create-joker-command" element={<JokerCommand />} />
        <Route path="/tutorial/create-joker-command/list-jc" element={<ListJokerCommand />} />
        ...
        <Route path="/dynasty-warriors-6" element={<DynastyWarrior6 />} />
