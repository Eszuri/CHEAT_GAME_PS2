    ...
    return (
        <>
            ...
            <div className='w-full bg-black p-2 text-left rounded overflow-hidden h-full'>
                ...
                <br />
                {/* pemisah */}
                <BOXCHANGELOG tanggal="29 April 2024">
                    <WebUpdateTittle tittle="Penambahan Cheat" />
                    <WebUpdate perubahan="Naruto Shippuuden - Ultimate Ninja 5" />
                </BOXCHANGELOG>
                {/* pemisah */}
                <BOXCHANGELOG tanggal="30 January 2024">
                    <WebUpdateTittle tittle="Penambahan Cheat" />
                    <WebUpdate perubahan="Dynasty Warriors 6 (belum selesai)" />
                </BOXCHANGELOG>
                {/* pemisah */}
                <BOXCHANGELOG tanggal="13 January 2024">
                    <WebUpdateTittle tittle="Penambahan Cheat" />
                    <WebUpdate perubahan="Downhill Domination" />
                </BOXCHANGELOG>
                {/* pemisah */}
