            ...
            <section className="fixed inset-x-0 inset-y-0 m-auto invisible" id="check" style={{ backgroundColor: 'rgba(0, 0, 0,0.8)' }}>
                <div className="absolute left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%]">
                    <div class="text-center">
                        <div role="status">
                            <svg aria-hidden="true" class="inline w-16 h-16 mr-2 text-gray-200 animate-spin dark:text-black fill-emerald-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
